...
FORTRAN_CYTHON_MODULES = cmbcr/harmonic_preconditioner.so cmbcr/rotate_alm.so cmbcr/block_matrix.so cmbcr/sympix_mg.so cmbcr/precond_pseudoinv_mod.so cmbcr/wigner.so
